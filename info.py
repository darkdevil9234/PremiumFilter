...
BOT_TOKEN = environ.get('BOT_TOKEN', '5257015155:AAHR9AGpwJLvj2UTulg0DCoU4d7soKHJ4Ek')
# Bot settings
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001720584562').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-1001902606759')
...
SHORTNER_API =  environ.get('SHORTNER_API', '811e36e9822b8c445582837748258bc00f7c6117')
